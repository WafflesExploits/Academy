...
namespace Academy
{
    partial class FES_ASDAY
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FES_ASDAY));
            ...
            this.CB_Time.MouseClick += new System.Windows.Forms.MouseEventHandler(this.CB_Workout_MouseClick);
            ...
            this.Text = "- [Academy]";
            this.Load += new System.EventHandler(this.FES_ASDAY_Load);
